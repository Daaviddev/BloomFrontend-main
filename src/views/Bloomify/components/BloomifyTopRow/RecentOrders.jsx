...
const RecentOrders = () => {
    ...
    return (
        <Panel lg={12} title={t("dashboard_commerce.recent_orders")}>
            <Table responsive className="table_bordered">
                <thead>
                    <tr>
                        {header.map(item => (
                            <th lassName="table_bordered" key={item.id}>
                                {item.title}
                            </th>
                        ))}
                    </tr>
                ...
                <tbody>
                    {rows.map(item => (
                        <tr className="table_bordered" key={item.id}>
                            <td>{item.id}</td>
                            <td>{item.invoice}</td>
                            ...
                            <td>{item.location}</td>
                            <td>
                                <Badge color={item.badge}>{item.status}</Badge>
                            </td>
                        </tr>
                    ))}
                </tbody>

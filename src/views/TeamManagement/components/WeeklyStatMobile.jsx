...
const WeeklyStatMobile = () => {
    ...
    return (
        <Panel md={12} lg={6} xl={3} xs={12} title={t("app_dashboard.weekly_stat_mobile")} subhead="Top selling items statistic by last month">
                ...
                <div className="dashboard__weekly-stat-chart">
                        ...
                        <div className="dashboard__weekly-stat-chart-pie">
                            <ResponsiveContainer width={110}>
                                <PieChart className="dashboard__weekly-stat-chart-pie-wrapper">
                                    <Pie data={data01} dataKey="value" cx={50} cy={50} innerRadius={50} outerRadius={55} />
                                </PieChart>
                            </ResponsiveContainer>
                    ...
                    <div className="dashboard__weekly-stat-chart-item">
                        <div className="dashboard__weekly-stat-chart-pie">
                            <ResponsiveContainer width={110}>
                                <PieChart className="dashboard__weekly-stat-chart-pie-wrapper">
                                    <Pie data={data02} dataKey="value" cx={50} cy={50} innerRadius={50} outerRadius={55} />
                                </PieChart>
                            </ResponsiveContainer>

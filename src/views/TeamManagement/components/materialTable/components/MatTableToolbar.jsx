...
const MatTableToolbar = ({ numSelected, handleDeleteSelected, onRequestSort }) => (
    <div className="material-table__toolbar-wrap">
        <Toolbar className="material-table__toolbar">
            ...
            <div>
                {numSelected > 0 ? (
                    <IconButton onClick={handleDeleteSelected} className="material-table__toolbar-button clor"></IconButton>
                ) : (
                    <MatTableFilterButton onRequestSort={onRequestSort} className="clor" color="white" />
                )}
            </div>
        </Toolbar>
    </div>

            ...
            <div dir={dir}>
                <ResponsiveContainer className="dashboard__chart-pie dashboard__chart-pie--crypto" height={360}>
                    <PieChart className="dashboard__chart-pie-container">
                        <Tooltip formatter={value => `$${trim(value, 2)}`} position={coordinate} {...getTooltipStyles(themeName)} />
                        <Pie data={data01} dataKey="value" cy={175} innerRadius={130} outerRadius={160} label={value => `$${trim(value.value, 2)}`} onMouseMove={onMouseMove} />

...
const RadioButtonField = ({ onChange, radioValue, className, disabled, label, name, value }) => {
    ...
    return (
        ...
        <label className={`${RadioButtonClass}${className ? ` radio-btn--${className}` : ""}`}>
            <input className="radio-btn__radio" name={name} type="radio" onChange={handleChange} checked={value === radioValue} disabled={disabled} />

...
const EditableCell = ({ value: initialValue, row: { index }, column: { id }, column, state, updateEditableData }) => {
        ...
        <div onDoubleClick={handleClick}>
            {isActiveInput ? (
                <div className="table__editable-table--cell-active">
                    <Input className="table__edit-form" value={value} onChange={onChange} onBlur={updateData} onKeyPress={handleKeyPress} />
                </div>
            ) : (
